...
<PL DOC_VERSION="1" VersionId="20261.." checksum="3386246764">
 <PARAMS_LIST>
  ...
  <PARAMETER Data_Path="w@component_1.rotaryload2ports_1" IS_DELTA="false" IS_LINKED_VARIABLE="false" Param_Id="2443" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="shaft speed at port 2" UNITS="rev/min" VALUE="0"/>
  <PARAMETER Data_Path="J@component_1.rotaryload2ports_1" IS_DELTA="false" Param_Id="2427" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="moment of inertia" TUNABLE="false" UNITS="kgm**2" VALUE="0.17"/>
  <PARAMETER Data_Path="vis@component_1.rotaryload2ports_1" IS_DELTA="false" Param_Id="2428" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="coefficient of viscous friction" TUNABLE="false" UNITS="Nm/(rev/min)" VALUE="1"/>
  <PARAMETER Data_Path="coul@component_1.rotaryload2ports_1" IS_DELTA="false" Param_Id="2429" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="Coulomb friction torque" TUNABLE="false" UNITS="Nm" VALUE="0"/>
  <PARAMETER Data_Path="stict@component_1.rotaryload2ports_1" IS_DELTA="false" Param_Id="2430" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="stiction torque" TUNABLE="false" UNITS="Nm" VALUE="0"/>
  <PARAMETER Data_Path="wind@component_1.rotaryload2ports_1" IS_DELTA="false" Param_Id="2431" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="coefficient of windage" TUNABLE="false" UNITS="Nm/(rev/min)**2" VALUE="0"/>
  <PARAMETER Data_Path="friction@component_1.rotaryload2ports_1" Param_Id="2432" Submodel_Instance="2" Submodel_Name="MECRL0" TITLE="use friction" TUNABLE="false" VALUE="1"/>
 </PARAMS_LIST>
 <EXPOSED_COPY_LIST/>
 <GLOBAL_PARAMS_LIST>
